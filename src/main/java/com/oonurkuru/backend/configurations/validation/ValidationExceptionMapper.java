...
/**
 * javax.validation arayüzlerinden faydalanarak kullanıcıya gönderilecek mesaj hazırlanıyor.
 */
@Provider
public class ValidationExceptionMapper implements ExceptionMapper<javax.validation.ValidationException> {
    ...
    public Response toResponse(javax.validation.ValidationException e) {
        ...
        return Response
                ...
                .entity(new ExceptionModel(300, "Validation Error", strBuilder.toString()))
                .build();
    }
}